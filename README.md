...
# 🎮 Figure Shop Simulator — Community Edition

**Run a collectible figure shop in this standalone simulation build.**
...
Figure Shop Simulator is a first-person business simulation game in which players open, stock, and grow a collectible figure shop. Tasks include ordering inventory, arranging displays, setting prices, and serving customers. This Community Edition is a standalone build distributed as a self-contained package, so it runs offline with no storefront required and no additional software needed.

For players who want a self-contained, offline Community Edition of the shop management simulator for Windows PCs.
...
<table>
 <tr>
 <td width="33%"><img src="https://shared.akamai.steamstatic.com/store_item_assets/steam/apps/3604560/9b7bff826b9f73930f3c56b2fe198a93e80d8481/ss_9b7bff826b9f73930f3c56b2fe198a93e80d8481.1920x1080.jpg?t=1786526222" alt="Screenshot 1" width="100%"></td>
 <td width="33%"><img src="https://shared.akamai.steamstatic.com/store_item_assets/steam/apps/3604560/36d213b4ec765385bc40ee7946636f4bbe7595be/ss_36d213b4ec765385bc40ee7946636f4bbe7595be.1920x1080.jpg?t=1786526222" alt="Screenshot 2" width="100%"></td>
 <td width="33%"><img src="https://shared.akamai.steamstatic.com/store_item_assets/steam/apps/3604560/23902e691c485412aa37d62fb5ca2846093771b3/ss_23902e691c485412aa37d62fb5ca2846093771b3.1920x1080.jpg?t=1786526222" alt="Screenshot 3" width="100%"></td>
 </tr>
</table>
...
- **Interface:** English, French, German, Spanish, Portuguese-Brazil, Russian, Simplified Chinese, Traditional Chinese, Japanese, Korean, Polish, Turkish
- **Voiceover:** English
...
- 🏪 **Full Shop Management** — Order stock, arrange shelves, set prices, and grow your store.
- 📦 **All Content Included** — Base game and every released add-on shipped in one package.
- 💾 **Offline Play** — Single-player mode runs fully offline after a one-time install.
- 🌐 **LAN Multiplayer** — LAN or direct P2P connection supported for co-op sessions.
- 🗜️ **Self-Contained Package** — Compressed lossless archive, ready to play immediately after extraction.
- 🗣️ **Multi-Language Interface** — Interface localized in 12 languages.
- ⚙️ **No Additional Software** — No storefront client or third-party launcher required.
- 🔧 **Standard Windows Build** — Installs like any regular PC application on Windows 10/11.

- **Compression:** Lossless
- **Install Time:** ~4 minutes on SSD, ~10 minutes on HDD
- **Recoding:** none
- **Selective Download:** You may skip downloading of language packs you do not need
...
| **RAM** | 8 GB | 16 GB |
| **Graphics** | NVIDIA GeForce GTX 1050 Ti (4 GB) or AMD Radeon RX 560 | NVIDIA GeForce RTX 3060 or AMD Radeon RX 6600 XT |
| **Storage** | 12 GB available space | 12 GB available space on SSD |
| **Additional** | DirectX 12 compatible sound card | SSD storage and broadband connection for LAN or direct multiplayer |
...
> 💡 **Saves location:** `%LOCALAPPDATA%\FigureShopSimulator\Saved`
